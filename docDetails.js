const getparams = () => {
    ...
    // Load available times and doctor details
    loadTime(param);
    ...
    fetch(`https://testing-8az5.onrender.com/doctor/review/?doctor_id=${param}`)
      ...
      .catch((err) => console.error("Error fetching doctor reviews:", err));
  };
  ...
  const displayDetails = (doctor) => {
    ...
    div.innerHTML = `
      ...
      <div class="doc-info">
        ...
        <p class="w-50">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Et quibusdam quis excepturi tempore. Eius, qui!
        </p>
  ...
  // Call getparams to initiate the process
  getparams();